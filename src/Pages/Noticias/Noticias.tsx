...
const Noticias = () => {
  ...
  return (
    ...
    <div className="p-5 flex flex-col justify-between h-full">
      ...
      <div>
        <p className="mb-3 font-normal text-gray-200">{noticias.introducao}</p>
      </div>

        <div>
          <p className='right-full'>{noticias.data_publicacao.split(' ')[0]}</p>
          <a href={noticias.link} target='_blank' className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-lime-700 rounded-lg hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-lime-300">
